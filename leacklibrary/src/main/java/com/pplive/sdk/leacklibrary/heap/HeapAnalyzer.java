...
import static com.pplive.sdk.leacklibrary.heap.AnalysisResult.failure;
import static com.pplive.sdk.leacklibrary.heap.AnalysisResult.leakDetected;
import static com.pplive.sdk.leacklibrary.heap.AnalysisResult.noLeak;
import static com.pplive.sdk.leacklibrary.heap.AnalyzerProgressListener.Step.BUILDING_LEAK_TRACE;
import static com.pplive.sdk.leacklibrary.heap.AnalyzerProgressListener.Step.COMPUTING_BITMAP_SIZE;
import static com.pplive.sdk.leacklibrary.heap.AnalyzerProgressListener.Step.COMPUTING_DOMINATORS;
import static com.pplive.sdk.leacklibrary.heap.AnalyzerProgressListener.Step.DEDUPLICATING_GC_ROOTS;
import static com.pplive.sdk.leacklibrary.heap.AnalyzerProgressListener.Step.FINDING_LEAKING_REF;
import static com.pplive.sdk.leacklibrary.heap.AnalyzerProgressListener.Step.FINDING_SHORTEST_PATH;
import static com.pplive.sdk.leacklibrary.heap.AnalyzerProgressListener.Step.PARSING_HEAP_DUMP;
import static com.pplive.sdk.leacklibrary.heap.AnalyzerProgressListener.Step.READING_HEAP_DUMP_FILE;
import static com.pplive.sdk.leacklibrary.heap.HahaHelper.asString;
import static com.pplive.sdk.leacklibrary.heap.HahaHelper.classInstanceValues;
import static com.pplive.sdk.leacklibrary.heap.HahaHelper.extendsThread;
import static com.pplive.sdk.leacklibrary.heap.HahaHelper.fieldValue;
import static com.pplive.sdk.leacklibrary.heap.HahaHelper.hasField;
import static com.pplive.sdk.leacklibrary.heap.HahaHelper.threadName;
import static com.pplive.sdk.leacklibrary.heap.HahaHelper.valueAsString;
import static com.pplive.sdk.leacklibrary.heap.LeakTraceElement.Holder.ARRAY;
import static com.pplive.sdk.leacklibrary.heap.LeakTraceElement.Holder.CLASS;
import static com.pplive.sdk.leacklibrary.heap.LeakTraceElement.Holder.OBJECT;
import static com.pplive.sdk.leacklibrary.heap.LeakTraceElement.Holder.THREAD;
import static com.pplive.sdk.leacklibrary.heap.LeakTraceElement.Type.ARRAY_ENTRY;
import static com.pplive.sdk.leacklibrary.heap.LeakTraceElement.Type.INSTANCE_FIELD;
import static com.pplive.sdk.leacklibrary.heap.LeakTraceElement.Type.STATIC_FIELD;

import static com.pplive.sdk.leacklibrary.heap.Reachability.REACHABLE;
import static com.pplive.sdk.leacklibrary.heap.Reachability.UNKNOWN;
import static com.pplive.sdk.leacklibrary.heap.Reachability.UNREACHABLE;
